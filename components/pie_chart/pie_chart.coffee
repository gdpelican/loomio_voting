  ...
  controller: ($scope, $element, $timeout) ->
    ...
    $timeout ->
      ...
      $scope.$watch 'proposal.voteCounts', ->
        ...
        voteCounts = $scope.proposal.voteCounts
        totalVotes = _.sum(voteCounts)
        voteAngle = 360/totalVotes
        totalSegments = countUniquePositions(voteCounts)
        sortedPositions = _.sortBy(_.pairs(voteCounts), (pair) -> - pair[1])
